...
consult the Javadoc for `cz.jeme.bestium.api.inject.Injectable`.
...
You can also explore the Bestium Javadoc and the open-source [Bestium Example plugin](https://github.com/huzvanec/BestiumExample) for inspiration.
:::
    ...
    <TabItem label="Java">
        ...
        public class Capybara extends CustomAnimal {
            ...
            public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
                return (Capybara) bestium_realType().create(level, EntitySpawnReason.BREEDING);
            }
        }
        ```
    </TabItem>
