...
## [`EntityInjection`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.html) interface
...
#### [`setBackingType(EntityType)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setBackingType(net.minecraft.world.entity.EntityType))
...
#### [`setDefaultAttributes(AttributeSupplier.Builder)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setDefaultAttributes(net.minecraft.world.entity.ai.attributes.AttributeSupplier))
...
<Tabs syncKey="lang">
    <TabItem label="Kotlin">
        ```kotlin
        .setDefaultAttributes(Capybara.createsetDefaultAttributes())
        ```
    </TabItem>
    <TabItem label="Java">
        ```java
...
#### [`setMobCategory(MobCategory)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setMobCategory(net.minecraft.world.entity.MobCategory))
...
#### [`setTypeCustomizer(Consumer<EntityType.Builder>)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setTypeCustomizer(java.util.function.Consumer))
...
#### [`setModel(PluginBootstrap, String)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setModel(io.papermc.paper.plugin.bootstrap.PluginBootstrap,java.lang.String))
...
#### [`setModel(File)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#setModel(java.io.File))
Sets the entity model displayed if [BetterModel](https://github.com/toxicity188/BetterModel) is installed on the server.
