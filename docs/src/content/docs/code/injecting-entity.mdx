...
#### [`backingType(EntityType)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#backingType(net.minecraft.world.entity.EntityType))
...
#### [`attributes(AttributeSupplier.Builder)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#attributes(net.minecraft.world.entity.ai.attributes.AttributeSupplier))
...
#### [`mobCategory(MobCategory)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#mobCategory(net.minecraft.world.entity.MobCategory))
...
#### [`typeCustomizer(Consumer<EntityType.Builder>)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#typeCustomizer(java.util.function.Consumer))
...
#### [`model(PluginBootstrap, String)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#model(io.papermc.paper.plugin.bootstrap.PluginBootstrap,java.lang.String))
...
#### [`model(File)`](/javadocs/cz/jeme/bestium/api/inject/EntityInjection.Builder.html#model(java.io.File))
Sets the entity model displayed if [BetterModel](https://github.com/toxicity188/BetterModel) is installed on the server.
...
<Tabs syncKey="lang">
    ...
    <TabItem label="Java">
        ...
        public void bootstrap(BootstrapContext context) {
            Bestium.injector().register(() -> EntityInjection.builder(
                                    Key.key("my_plugin", "capybara"),
                                    Capybara.class,
                                    Capybara::new,
                                    CraftAnimals::new
